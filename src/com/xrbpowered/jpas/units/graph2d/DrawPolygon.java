...
public class DrawPolygon extends StdProcedure {
	...
	public Object call(Object[] args) {
		...
		t.gr.drawPolygon(FillPolygon.getIntValues((ArrayObject) args[1]), FillPolygon.getIntValues((ArrayObject) args[2]), (Integer) args[0]);
		return null;
	}
